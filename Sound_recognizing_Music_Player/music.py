...
def setting():
    ...
    def colors():
        ...
        def green():
            ...
            volum.configure(background="plime green")
...
def Acommand():
    ...
    if __name__ == "__main__":
        ...
        # if 1:
            ...
            # speaking part of the code........ command through speech  
            if 'play' in query:
                list_input=[]
                x=str(query)
                x.split()
    ...
    if __name__ == "__main__":
        ...
        while True:
            ...
            if "pink" in query:
                ...
                timebar.configure(background= "pink")
                heading.configure(background="pink")
                lst.configure(background="lavendra")
                volum.configure(background="pink")
                plist.configure(background="pink")
                break
            elif "green" in query:
...
reverse_button= ttk.Button(player, text="Play A gain", command=reverse1)
...
audio_command.place(x=262, y=115)

...
def Acommand():
    ...
    if __name__ == "__main__":
        speak("Hey Bashir Alam. Please tell me how may I help you") 
        while True:
        # if 1:
            query = takeCommand().lower()
            if 'stop' in query:
...
play= PhotoImage( file="C:\\Users\\bashir.alam\\Documents\\subjects\\freshman\\computer science\\music player + sound recognitionplay\\play.png")
play_button= Button(player, image= play, command=play1, bg="black")
play_button.place(x= 200, y= 30)

pause= PhotoImage(file="C:\\Users\\bashir.alam\\Documents\\computer science\\music player\\pause.png")
pause_button= Button(player, image=pause,  command=pause1, bg="black")
pause_button.place(x=250, y=30)

stop= PhotoImage(file="C:\\Users\\bashir.alam\\Documents\\computer science\\music player\\stop.png")
...
sound= PhotoImage(file="C:\\Users\\bashir.alam\\Documents\\computer science\\music player\\play.png")

reverse_button= ttk.Button(player, text="Play Again", command=reverse1)
reverse_button.place(x=395, y=75)

mute=PhotoImage(file="C:\\Users\\bashir.alam\\Documents\\computer science\\music player\\mute.png")
not_mute=PhotoImage(file="C:\\Users\\bashir.alam\\Documents\\computer science\\music player\\volume.png")
